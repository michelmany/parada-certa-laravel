...
@section('content')
    ...
    <section>
        ...
        <div class="container">
            ...
            <div class="col-md-9">
                <h1>1ª Habilitação - Carro (B)</h1><hr>
                <div class="row">
                    <div class="col-md-8">
                        <p class="lead">
                            A habilitação categoria "B" compreende a condução de veículos com ou sem reboque, motorizados cujo peso máximo autorizado não exceda a 3,5 toneladas e não ultrapasse de 8 (oito) lugares além do condutor.
                        </p>
